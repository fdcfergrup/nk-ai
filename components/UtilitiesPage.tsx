...
const UtilitiesPage: React.FC<UtilitiesPageProps> = ({ onModuleClick, onNavigate }) => {
            ...
            <section className="py-16 md:py-24">
                <div className="container mx-auto px-4 sm:px-6">
                    <div className="text-center mb-12">
                        <h1 className="text-3xl md:text-5xl font-bold font-heading text-text-primary">Siêu Trợ lý cho Công việc Hàng ngày</h1>
                        <p className="mt-4 text-lg text-text-secondary max-w-3xl mx-auto">Bộ công cụ AI toàn năng giúp bạn tự động hóa, sáng tạo và tăng tốc mọi tác vụ văn phòng. Các tính năng có ✨ được hỗ trợ bởi Gemini API.</p>
                    </div>
